...
function showFormSuccess(form, submitBtn) {
  form.innerHTML = `
    <div style="text-align: center; padding: 40px 20px;">
      ...
      <h3 style="font-size: 1.5rem; font-weight: 700; color: white; margin-bottom: 12px;">Booking Confirmed!</h3>
      <p style="color: rgba(255,255,255,0.75); font-size: 1rem; line-height: 1.6; margin-bottom: 24px;">
        Thank you! Our counsellor will call you within 2 hours to schedule your free session.
      </p>
      <div style="background: rgba(255,255,255,0.1); border-radius: 12px; padding: 16px 20px; display: inline-block;">
        <p style="color: rgba(255,255,255,0.85); font-size: 0.875rem; font-weight: 500;">
          💬 Meanwhile, you can also <strong>WhatsApp us</strong> at<br/>+91 XXXXX XXXXX for immediate assistance.
        </p>
      </div>
    </div>
  `;
