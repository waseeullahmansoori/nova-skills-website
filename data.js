...
/* Academy Specific Landing Page Content Data (Phase A3 & 2026 Premium Edition) */
const NS_ACADEMY_LANDING_DATA = {
  "digital-marketing": {
    "headline": "Launch a High-Growth Career in AI-Powered Digital Marketing & Performance Advertising",
    ...
    "salaryInsights": {
      ...
      "freelancing": "₹40k – ₹1.8L / month",
      "entrepreneurship": "₹2.5L – ₹10.0L+ / month"
    },
  ...
  "ai": {
    "headline": "Master AI Productivity, Prompt Engineering, Autonomous Agents & n8n Workflows",
    "skills": ["Advanced Prompt Engineering", "n8n & Make Workflow Automation", "ChatGPT & Claude 3.5 Sonnet Integration", "Midjourney & DALL-E Generative AI", "Custom AI Chatbots & RAG Systems", "Python for AI Automation", "AI Web Scraping & Data Extraction", "Generative AI Code Assistants"],
    "overview": {
      "intro": "The AI Academy is designed to transform professionals, developers, and creators into high-value AI specialists capable of building automated workflows and AI agents.",
      "benefits": ["100% Hands-on AI Lab Projects", "Zero-Code to Low-Code Automation Training", "Official AI Practitioner Certificate", "Direct Referrals to Top AI Tech Employers"],
      "outcomes": ["Automate complex business and creative processes", "Develop custom AI chatbots and knowledge base agents", "Boost personal work output by up to 10x", "Offer high-margin AI automation consulting services"]
    },
    "tools": [
    ...
    "salaryInsights": {
      ...
      "freelancing": "₹60k – ₹2.5L / month",
      "entrepreneurship": "₹3.5L – ₹15.0L+ / month"
    },
    "hiringIndustries": ["AI Automation Agencies", "SaaS & Product Enterprises", "Management Consultancies", "Financial & FinTech Institutions", "Global Tech Startups"],
    "portfolio": [
  ...
  "design": {
    "headline": "Transform Creative Ideas into Stunning Brand Identity, Graphic Design & UI/UX Prototypes",
    "skills": ["UI/UX Design in Figma", "Graphic Design in Photoshop & Illustrator", "Brand Identity & Logo Systems", "Vector Art & Layout Composition", "Midjourney AI Design Workflows", "3D Web Graphics in Spline", "Design Systems & Component Libraries", "Behance & Dribbble Portfolio"],
    "overview": {
      "intro": "Master visual communication, graphic design, and modern UI/UX design to build captivating digital products and high-impact brand identities.",
      "benefits": ["Real Client Creative Brief Assignments", "Behance & Dribbble Verified Portfolio", "Industry-Grade Figma & Adobe Masterclasses", "Lifetime Career & Placement Support"],
      "outcomes": ["Create interactive mobile and web prototypes", "Build unified corporate brand identity systems", "Gain mastery over industry-standard design tools", "Land high-paying UI/UX and graphic designer roles"]
    },
    "tools": [
    ...
    "salaryInsights": {
      ...
      "freelancing": "₹45k – ₹2.0L / month",
      "entrepreneurship": "₹2.0L – ₹12.0L+ / month"
    },
    "hiringIndustries": ["Product & UI/UX Design Studios", "Creative Advertising Agencies", "Tech & App Development Companies", "E-Commerce & Retail Giants", "Media & Publishing Houses"],
    "portfolio": [
  ...
  "programming": {
    "headline": "Build Full Stack Web Apps, REST APIs, Databases & Scalable Software Solutions",
    "skills": ["Full Stack Development (MERN)", "Python Programming & Data Logic", "JavaScript ES6+ & TypeScript", "React.js Component Architecture", "Node.js & Express API Servers", "SQL, PostgreSQL & MongoDB", "Git, GitHub & CI/CD Deployment", "System Architecture & Security"],
    "overview": {
      "intro": "The Programming Academy provides a complete software engineering launchpad covering frontend, backend, database design, and cloud deployment.",
      "benefits": ["100% Live Code Lab Sessions", "5+ Production-Ready Full Stack Projects", "DSA & Technical Interview Bootcamps", "Direct Developer Referrals"],
      "outcomes": ["Develop responsive, fast web applications", "Build secure RESTful APIs and microservices", "Deploy apps live on cloud infrastructure", "Secure software engineering jobs globally"]
    },
    "tools": [
      { "name": "VS Code", "icon": "💻" },
      { "name": "Python", "icon": "🐍" },
    ...
    "salaryInsights": {
      ...
      "freelancing": "₹50k – ₹2.2L / month",
      "entrepreneurship": "₹3.0L – ₹15.0L+ / month"
    },
    "hiringIndustries": ["IT Services & Product Companies", "Software Engineering Consultancies", "FinTech & Banking Corporations", "SaaS & Cloud Platforms", "Global Remote Tech Employers"],
    "portfolio": [
  ...
  "no-code-web": {
    "headline": "Design & Build High-Converting Web Platforms, E-Commerce Stores & Webflow Sites Without Coding",
    "skills": ["WordPress & Elementor Pro", "Shopify & WooCommerce Store Setup", "Webflow Responsive Web Design", "Framer Interactive Landing Pages", "Payment Gateway & Inventory Integration", "Speed, Security & SEO Optimization", "CRM & Lead Automation", "Client Delivery Workflows"],
    "overview": {
      "intro": "Build professional e-commerce stores, SaaS landing pages, and business portals using state-of-the-art No-Code platforms.",
      "benefits": ["Build Complete Client Sites from Scratch", "Sandbox Server Access Provided", "High Freelance Project Demand", "100% Practical Client Onboarding Training"],
      "outcomes": ["Deliver responsive websites in days instead of months", "Integrate automated checkout and payment solutions", "Optimize site performance and conversion rates", "Establish a high-income freelance web agency"]
    },
    "tools": [
      { "name": "WordPress", "icon": "🌐" },
    ...
    "salaryInsights": {
      ...
      "freelancing": "₹35k – ₹1.6L / month",
      "entrepreneurship": "₹2.0L – ₹8.0L+ / month"
    },
    "hiringIndustries": ["E-Commerce & Retail Businesses", "Web Development Agencies", "Local Business Enterprises", "Digital Marketing Firms", "Independent Freelance Marketplaces"],
    "portfolio": [
  ...
  "video-motion": {
    "headline": "Create Cinematic Videos, Motion Graphics, VFX & High-Engagement Social Reels",
    ...
    "hiringIndustries": ["Video Production Houses", "Social Media Content Agencies", "Advertising & PR Agencies", "Television & Film Post-Production", "Top Creator & Influencer Teams"],
    "portfolio": [
  ...
  "3d": {
    "headline": "Master 3D Modeling, Photorealistic Architectural Renders & Unreal Engine Environments",
    "skills": ["Autodesk 3ds Max Modeling", "Blender 3D Asset Creation", "V-Ray & Corona Lighting & Texturing", "Architectural Exterior & Interior Renders", "Twinmotion Real-Time Rendering", "Unreal Engine 5 Environment Design", "Substance Painter PBR Texturing", "AutoCAD 2D-to-3D Conversion"],
    "overview": {
      "intro": "The 3D Academy equips you with high-precision 3D visualization, photorealistic rendering, and architectural walkthrough capabilities.",
      "benefits": ["Photorealistic Studio Render Labs", "Architectural & Product Visualizations", "Unreal Engine Real-time Workflows", "Portfolio Showcase Ready for Recruiters"],
      "outcomes": ["Produce magazine-quality 3D architectural renders", "Create immersive 3D walkthrough animations", "Build game-ready 3D PBR assets", "Land lucrative roles in real estate and gaming"]
    },
    "tools": [
    ...
    "salaryInsights": {
      ...
      "mid": "₹6.5 – ₹11.5 LPA",
      "senior": "₹12.0 – ₹22.0+ LPA",
      "freelancing": "₹50k – ₹2.0L / month",
      "entrepreneurship": "₹3.0L – ₹12.0L+ / month"
    },
    "hiringIndustries": ["Architectural & Interior Design Firms", "Real Estate Developers", "Gaming & Entertainment Studios", "Product Design Studios", "AR/VR Tech Companies"],
    "portfolio": [
  ...
  "career-freelancing": {
    "headline": "Master Freelance Client Acquisition, International Upwork/Fiverr Growth & Agency Scale",
    "skills": ["Upwork & Fiverr Profile Optimization", "High-Converting Proposal Writing", "Cold Email & LinkedIn Prospecting", "USD International Payment Setup", "High-Value Client Negotiation Tactics", "Service Packaging & Retainer Contracts", "Notion & ClickUp Project Management", "Building & Scaling a Micro-Agency"],
    "overview": {
      "intro": "Accelerate your career through high-income freelancing, remote job placement, and international client acquisition strategies.",
      "benefits": ["Live Proposal Scripting Workshops", "USD Foreign Earnings Integration", "1-on-1 Mentor Account Audits", "Lifetime Agency Scaling Support"],
      "outcomes": ["Win remote global clients paying in foreign currency", "Achieve Top-Rated freelancer status on Upwork", "Build a high-margin recurring client pipeline", "Transition from solo freelancer to agency owner"]
    },
    "tools": [
    ...
    "salaryInsights": {
      "entry": "₹4.0 – ₹6.0 LPA ($1,000/mo)",
      "mid": "₹7.0 – ₹12.0 LPA ($2,000/mo)",
      "senior": "₹13.0 – ₹25.0+ LPA ($4,000+/mo)",
      "freelancing": "₹50k – ₹3.0L / month",
      "entrepreneurship": "₹3.0L – ₹15.0L+ / month"
    },
    "hiringIndustries": ["Global Remote Work Marketplaces", "International Tech & Creative Clients", "Remote Service Consultancies", "Freelance Staffing Firms", "Independent Micro-Agencies"],
    "portfolio": [
  ...
  "communication": {
    "headline": "Master Spoken English, Corporate Presentation Skills, Public Speaking & Executive Presence",
    "skills": ["Fluent Spoken English Practice", "Corporate Presentation & Slide Decks", "Public Speaking & Stage Confidence", "Professional Email & Business Writing", "Executive Interview Preparation", "Voice Accent & Tone Calibration", "High-Stakes Negotiation Tactics", "Personality & Body Language"],
    "overview": {
      "intro": "Develop powerful spoken English, commanding public speaking abilities, and seamless corporate communication skills.",
      "benefits": ["Interactive Speaking & Roleplay Labs", "Video-Recorded Presentation Analysis", "1-on-1 Mock Interview Coaching", "ISO Certificate in Business English"],
      "outcomes": ["Speak English effortlessly in meetings and interviews", "Deliver persuasive corporate keynote presentations", "Ace high-level job interview rounds", "Accelerate promotion cycles into leadership roles"]
    },
    "tools": [
    ...
    "salaryInsights": {
      ...
      "mid": "₹5.5 – ₹9.0 LPA",
      "senior": "₹9.5 – ₹16.0+ LPA",
      "freelancing": "₹30k – ₹1.2L / month",
      "entrepreneurship": "₹1.5L – ₹6.0L+ / month"
    },
    "hiringIndustries": ["Multinational Corporations (MNCs)", "Corporate Communications Departments", "Client Relations & Sales Enterprises", "Educational & Training Institutes", "Global Customer Operations"],
    "portfolio": [
  ...
  "kids-tech": {
    "headline": "Inspire Young Minds with Fun Coding, Game Development, Robotics & STEM Creativity",
    "skills": ["Scratch 3.0 Game Programming", "Python Logic for Young Coders", "MIT Mobile App Invention", "Tinkercad 3D Design & Modeling", "Robotics & Micro:bit Hardware", "Web Design Basics (HTML/CSS)", "Creative AI Tools for Kids", "Algorithmic Problem-Solving"],
    "overview": {
      "intro": "Empower kids aged 8 to 16 with future-ready STEM skills, logical thinking, game development, and fun technology creation.",
      "benefits": ["Certified Child STEM Specialists", "Small Interactive Mentor Batches", "100% Safe & Encouraging Environment", "Build a Personal STEM Portfolio"],
      "outcomes": ["Develop logical reasoning and math skills", "Publish self-made interactive games and apps", "Build confidence through project presentation", "Gain early advantage for future top admissions"]
    },
    "tools": [
    ...
    "salaryInsights": {
      "entry": "STEM Logic Builder",
      "mid": "Game & App Creator",
      "senior": "STEM Competition Winner",
      "freelancing": "Coding Club Leader",
      "entrepreneurship": "Young Tech Innovator"
    },
    "hiringIndustries": ["STEM Competitions & Hackathons", "School Coding & Robotics Clubs", "Advanced International Academic Paths"],
    "portfolio": [
  ...
  "creator": {
    "headline": "Build Your Personal Brand, Monetize YouTube Channels, Master Short Video & Podcasts",
    "skills": ["YouTube Channel Strategy & SEO", "Short-Form Reel Storytelling", "High CTR Thumbnail Design", "Podcast Recording & Audio Editing", "Personal Brand Monetization", "Generative AI Script & Hook Writing", "Content Calendar System in Notion", "Live Streaming Setup in OBS"],
    "overview": {
      "intro": "Learn to script, record, edit, and monetize content across YouTube, Instagram, Spotify, and digital products.",
      "benefits": ["Hands-on Camera & Studio Labs", "Monetization Strategy Masterclasses", "High CTR Thumbnail Design Training", "Creator Community & Networking"],
      "outcomes": ["Launch and grow a monetized YouTube channel", "Generate income through sponsorships and affiliate deals", "Build a strong personal brand in your niche", "Manage digital media companies for creators"]
    },
    "tools": [
    ...
    "salaryInsights": {
      ...
      "freelancing": "₹50k – ₹2.5L / month",
      "entrepreneurship": "₹3.0L – ₹20.0L+ / month"
    },
    "hiringIndustries": ["Digital Media & Creator Companies", "YouTube Channel Management Agencies", "Podcast Networks & Streaming Platforms", "Brand Sponsorship Agencies", "Independent Content Creators"],
    "portfolio": [
  ...
  "office-productivity": {
    "headline": "Master Advanced Excel, Tally Prime GST, Microsoft Copilot AI & Office Automations",
    "skills": ["Advanced Excel (VLOOKUP, XLOOKUP, Pivot, Macros)", "Microsoft Copilot AI Productivity", "Tally Prime Accounting & GST Filings", "Corporate PowerPoint Pitch Decks", "Word Document Formatting & Automation", "Google Workspace & Cloud Sharing", "Notion & ClickUp Task Management", "MIS Reporting & Data Dashboards"],
    "overview": {
      "intro": "Boost workplace efficiency, master corporate data reporting, and handle enterprise accounting with GST and AI tools.",
      "benefits": ["Practical Accounting & Excel Labs", "Live GST Filing Case Studies", "Microsoft Copilot Automation Training", "ISO Certification in Office Tech"],
      "outcomes": ["Automate complex office data tasks in minutes", "Handle corporate accounting and GST filings independently", "Create executive pitch decks and MIS dashboards", "Qualify for top office management and MIS roles"]
    },
    "tools": [
    ...
    "hiringIndustries": ["Corporate Offices & MNCs", "Accounting & Tax Consultancy Firms", "Government & Enterprise Sector", "Logistics & Supply Chain Companies", "Financial & Administrative Agencies"],
    "portfolio": [
...
const NS_BLOG_POSTS = [
  {
    ...
    "content": "Waseeullah Mansoori founder story multimedia digital marketing AI education practical skills career transformation Nova Skills institute.",
    "category": "Founder Story",
    "author": "Waseeullah Mansoori",
    "authorRole": "Founder, Nova Skills",
    "featuredImage": "/images/seo/waseeullah-mansoori.png",
    ...
    "featured": true,
    "trending": true,
    "seoTitle": "Meet Waseeullah Mansoori — Founder of Nova Skills",
    "metaDescription": "Discover Waseeullah Mansoori's 11+ year journey from multimedia designer & marketer to founding Nova Skills.",
    "ogImage": "https://novaskills.in/images/seo/waseeullah-mansoori.png"
  },
  {
    "id": 1,
    "slug": "ai-jobs-india-2026",
    "url": "blog-detail.html?id=ai-jobs-india-2026",
    ...
    "content": "Top 15 AI jobs in India 2026 artificial intelligence machine learning prompt engineering AI automation salary skills guide.",
    "category": "AI & Automation",
    "author": "Sanya Puri",
    "authorRole": "Lead AI Trainer",
    "featuredImage": "/public/images/seo/og-blog-ai-jobs-india-2026.png",
    "image": null,
    ...
    "featured": false,
    "trending": true,
    "seoTitle": "Top 15 AI Jobs in India 2026",
    "metaDescription": "Discover highest-paying AI roles in India.",
    "ogImage": "https://novaskills.in/public/images/seo/og-blog-ai-jobs-india-2026.png"
  },
  {
    "id": 2,
    "slug": "digital-marketing-salary-india",
    "url": "blog-detail.html?id=digital-marketing-salary-india",
    ...
    "content": "Digital marketing salary guide India 2026 SEO PPC social media performance marketing salaries top cities.",
    "category": "Digital Marketing",
    "author": "Arjun Kapoor",
    "authorRole": "Head of Digital Marketing",
    "featuredImage": "/public/images/seo/og-blog-digital-marketing-salary-india.png",
    "image": null,
    ...
    "featured": false,
    "trending": true,
    "seoTitle": "Digital Marketing Salary in India 2026",
    "metaDescription": "Complete guide to digital marketing salaries in India.",
    "ogImage": "https://novaskills.in/public/images/seo/og-blog-digital-marketing-salary-india.png"
  },
  {
    "id": 3,
    "slug": "learn-graphic-design-beginner-guide",
    "url": "blog-detail.html?id=learn-graphic-design-beginner-guide",
    ...
    "content": "Graphic design beginner guide 2026 Photoshop Illustrator Figma branding UI UX portfolio clients.",
    "category": "Graphic Design",
    "author": "Rajan Verma",
    "authorRole": "Senior Design Trainer",
    "featuredImage": "/public/images/seo/og-blog-learn-graphic-design-beginner-guide.png",
    "image": null,
    ...
    "featured": false,
    "trending": false,
    "seoTitle": "How to Learn Graphic Design from Scratch 2026",
    "metaDescription": "Step by step guide to graphic design from scratch.",
    "ogImage": "https://novaskills.in/public/images/seo/og-blog-learn-graphic-design-beginner-guide.png"
  },
  {
    "id": 4,
    "slug": "freelancing-fiverr-india-guide",
    "url": "blog-detail.html?id=freelancing-fiverr-india-guide",
    ...
    "content": "Freelancing on Fiverr in India 1 lakh per month income freelance strategies client acquisition gig optimisation.",
    "category": "Freelancing",
    "author": "Priya Kumar",
    "authorRole": "Freelancing Success Coach",
    "featuredImage": "/public/images/seo/og-blog-freelancing-fiverr-india-guide.png",
    "image": null,
    ...
    "featured": false,
    "trending": true,
    "seoTitle": "How to Earn ₹1 Lakh/Month Freelancing on Fiverr",
    "metaDescription": "Practical guide to 6-figure freelancing income.",
    "ogImage": "https://novaskills.in/public/images/seo/og-blog-freelancing-fiverr-india-guide.png"
  },
  {
    "id": 5,
    "slug": "n8n-ai-automation-beginners",
    "url": "blog-detail.html?id=n8n-ai-automation-beginners",
    ...
    "content": "n8n AI automation tutorial no-code AI workflows AI agents process automation.",
    "category": "AI & Automation",
    "author": "Sanya Puri",
    "authorRole": "Lead AI Trainer",
    "featuredImage": "/public/images/seo/og-blog-n8n-ai-automation-beginners.png",
    "image": null,
    ...
    "featured": false,
    "trending": false,
    "seoTitle": "n8n AI Automation for Beginners 2026",
    "metaDescription": "Step-by-step tutorial to build AI automation workflows.",
    "ogImage": "https://novaskills.in/public/images/seo/og-blog-n8n-ai-automation-beginners.png"
  },
  {
    "id": 6,
    "slug": "youtube-channel-monetise-2026",
    "url": "blog-detail.html?id=youtube-channel-monetise-2026",
    ...
    "content": "YouTube channel monetisation 2026 content creation video editing Premiere Pro algorithm growth.",
    "category": "Motion Graphics",
    "author": "Mohammed Tahir",
    "authorRole": "Creator Academy Lead",
    "featuredImage": "/public/images/seo/og-blog-youtube-channel-monetise-2026.png",
    "image": null,
    ...
    "featured": false,
    "trending": false,
    "seoTitle": "How to Start & Monetise YouTube Channel 2026",
    "metaDescription": "Complete guide to YouTube channel growth and monetisation.",
    "ogImage": "https://novaskills.in/public/images/seo/og-blog-youtube-channel-monetise-2026.png"
  },
  {
    "id": 7,
    "slug": "chatgpt-prompts-marketing",
    "url": "blog-detail.html?id=chatgpt-prompts-marketing",
    ...
    "content": "50 ChatGPT prompts digital marketing copy SEO Google Ads Meta Ads email sequences.",
    "category": "Performance Marketing",
    "author": "Arjun Kapoor",
    "authorRole": "Head of Digital Marketing",
    "featuredImage": "/public/images/seo/og-blog-chatgpt-prompts-marketing.png",
    "image": null,
    ...
    "featured": false,
    "trending": false,
    "seoTitle": "50 ChatGPT Prompts for Marketing 2026",
    "metaDescription": "50 expert prompts for marketing, copy, and SEO.",
    "ogImage": "https://novaskills.in/public/images/seo/og-blog-chatgpt-prompts-marketing.png"
  },
  {
    "id": 8,
    "slug": "kids-coding-benefits-india",
    "url": "blog-detail.html?id=kids-coding-benefits-india",
    ...
    "content": "Kids coding education India logic technology future skills STEM parents guide.",
    "category": "Student Success",
    "author": "Dr. Sunita Rao",
    "authorRole": "Kids Tech Academy Director",
    "featuredImage": "/public/images/seo/og-blog-kids-coding-benefits-india.png",
    "image": null,
    ...
    "featured": false,
    "trending": false,
    "seoTitle": "Why Every Indian Child Should Learn Coding",
    "metaDescription": "Importance of coding education for children in India.",
    "ogImage": "https://novaskills.in/public/images/seo/og-blog-kids-coding-benefits-india.png"
  },
  {
    "id": 9,
    "slug": "python-vs-javascript-2026",
    "url": "blog-detail.html?id=python-vs-javascript-2026",
    ...
    "content": "Python vs JavaScript 2026 programming web development career paths comparison.",
    "category": "Web Development",
    "author": "Vikram Nair",
    "authorRole": "Programming Academy Lead",
    "featuredImage": "/public/images/seo/og-blog-python-vs-javascript-2026.png",
    "image": null,
    ...
    "featured": false,
    "trending": false,
    "seoTitle": "Python vs JavaScript in 2026",
    "metaDescription": "Ultimate comparison between Python and JavaScript.",
    "ogImage": "https://novaskills.in/public/images/seo/og-blog-python-vs-javascript-2026.png"
  },
  {
    "id": 10,
    "slug": "ui-ux-design-roadmap",
    "url": "blog-detail.html?id=ui-ux-design-roadmap",
    ...
    "content": "UI UX design roadmap 2026 Figma wireframing design systems portfolio career.",
    "category": "Graphic Design",
    "author": "Priya Mehta",
    ...
    "featured": false,
    "trending": true,
    "seoTitle": "UI/UX Design Roadmap 2026",
    "metaDescription": "Step-by-step learning path for UI/UX design.",
    "ogImage": "https://novaskills.in/public/images/seo/og-blog-learn-graphic-design-beginner-guide.png"
  },
  {
    "id": 11,
    "slug": "motion-graphics-after-effects-guide",
    "url": "blog-detail.html?id=motion-graphics-after-effects-guide",
    "title": "Top 10 Motion Graphics & After Effects Techniques for Beginners 2026",
    "excerpt": "Master keyframes, kinetic typography, shape animations and visual effects in Adobe After Effects to create high-impact motion graphics.",
    "content": "Motion graphics After Effects techniques keyframes kinetic typography video animation.",
    "category": "Motion Graphics",
    "author": "Mohammed Tahir",
    "authorRole": "Creator Academy Lead",
    "featuredImage": "/public/images/seo/og-blog-youtube-channel-monetise-2026.png",
    ...
    "featured": false,
    "trending": true,
    "seoTitle": "Top 10 Motion Graphics Techniques 2026",
    "metaDescription": "Master motion graphics and After Effects techniques for beginners.",
    "ogImage": "https://novaskills.in/public/images/seo/og-blog-youtube-channel-monetise-2026.png"
  },
  {
    "id": 12,
    "slug": "video-editing-premiere-pro-2026",
    "url": "blog-detail.html?id=video-editing-premiere-pro-2026",
    "title": "Master Video Editing with Premiere Pro: Complete Creator Roadmap",
    "excerpt": "Learn professional video cutting, color grading, audio cleanup and fast workflow techniques to edit high-converting reels and YouTube videos.",
    "content": "Video editing Premiere Pro creator roadmap color grading audio editing shorts reels.",
    ...
    "featured": false,
    "trending": false,
    "seoTitle": "Master Video Editing with Premiere Pro 2026",
    "metaDescription": "Complete creator roadmap to master Adobe Premiere Pro.",
    "ogImage": "https://novaskills.in/public/images/seo/og-blog-youtube-channel-monetise-2026.png"
  },
  {
    "id": 13,
    "slug": "full-stack-web-development-roadmap",
    "url": "blog-detail.html?id=full-stack-web-development-roadmap",
    "title": "Full Stack Web Development Roadmap 2026: HTML, CSS, JS, React & Node",
    "excerpt": "Complete developer pathway from front-end basics to back-end APIs, databases and cloud deployment for high-paying web developer jobs.",
    "content": "Full stack web development roadmap HTML CSS JavaScript React Node database API Cloudflare.",
    "category": "Web Development",
    "author": "Vikram Nair",
    "authorRole": "Programming Academy Lead",
    "featuredImage": "/public/images/seo/og-blog-python-vs-javascript-2026.png",
    ...
    "featured": false,
    "trending": true,
    "seoTitle": "Full Stack Web Development Roadmap 2026",
    "metaDescription": "Step-by-step full stack developer learning path.",
    "ogImage": "https://novaskills.in/public/images/seo/og-blog-python-vs-javascript-2026.png"
  },
  {
    "id": 14,
    "slug": "seo-geo-generative-engine-optimisation",
    "url": "blog-detail.html?id=seo-geo-generative-engine-optimisation",
    "title": "SEO vs GEO: How to Rank Your Website on Google, ChatGPT & Perplexity",
    "excerpt": "Generative Engine Optimisation (GEO) is revolutionising search. Learn how to optimise your content for AI search engines alongside traditional Google SEO.",
    "content": "SEO vs GEO generative engine optimisation AI search ChatGPT Perplexity Google ranking.",
    "category": "SEO",
    "author": "Waseeullah Mansoori",
    "authorRole": "Founder, Nova Skills",
    "featuredImage": "/public/images/seo/og-blog.png",
    "image": null,
    ...
    "featured": false,
    "trending": true,
    "seoTitle": "SEO vs GEO: Rank on Google, ChatGPT & Perplexity",
    "metaDescription": "Master Generative Engine Optimisation alongside traditional SEO.",
    "ogImage": "https://novaskills.in/public/images/seo/og-blog.png"
  },
  {
    "id": 15,
    "slug": "canva-vs-photoshop-graphic-design",
    "url": "blog-detail.html?id=canva-vs-photoshop-graphic-design",
    "title": "Canva vs Photoshop: Which Tool Should Graphic Designers Use in 2026?",
    "excerpt": "Comparing speed, flexibility, professional standards and client expectations between Canva and Adobe Photoshop for modern visual designers.",
    "content": "Canva vs Photoshop graphic design tools comparison speed professional standards branding.",
    "category": "Graphic Design",
    "author": "Rajan Verma",
    "authorRole": "Senior Design Trainer",
    "featuredImage": "/public/images/seo/og-blog-learn-graphic-design-beginner-guide.png",
    ...
    "featured": false,
    "trending": false,
    "seoTitle": "Canva vs Photoshop for Designers 2026",
    "metaDescription": "Detailed tool comparison for graphic designers.",
    "ogImage": "https://novaskills.in/public/images/seo/og-blog-learn-graphic-design-beginner-guide.png"
  }
];
